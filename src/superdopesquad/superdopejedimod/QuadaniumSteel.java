...
public class QuadaniumSteel extends BaseBlock {
	...
	public void registerRecipe() {
		...
		GameRegistry.addShapelessRecipe(this.getRegistryName(), null, quadaniumSteelIngotStackNine, Ingredient.fromStacks(new ItemStack(this)));
    	...
    	GameRegistry.addShapedRecipe(this.getRegistryName(), null, quadaniumSteelIngotStackNine, "xxx", "xyx", "xxx", 'x', ironIngotStack, 'y', inkSacStack);
	}
}
