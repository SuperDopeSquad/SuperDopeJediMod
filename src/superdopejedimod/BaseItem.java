...
public abstract class BaseItem extends Item implements SuperDopeObject {
	...
	public void registerModel() {
	    ...
	    renderItem.getItemModelMesher().register(this, 0, new net.minecraft.client.renderer.block.model.ModelResourceLocation(SuperDopeJediMod.MODID + ":" + ((BaseItem) this).getName(), "inventory"));
	}
}
