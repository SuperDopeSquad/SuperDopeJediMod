...
public class TuskanRaiderModel extends ModelBase
{
          ...
          float par4, float parHeadAngleY, float parHeadAngleX, float par7)
    {
        ...
        renderTuskanRaider((TuskanRaiderEntity) parEntity, parTime, parSwingSuppress, par4, 
              parHeadAngleY, parHeadAngleX, par7);
    }
    
    public void renderTuskanRaider(TuskanRaiderEntity parEntity, float parTime, float parSwingSuppress, 
          float par4, float parHeadAngleY, float parHeadAngleX, float par7)
    {
