...
public class WookieRender extends RenderLiving {
    ...
    {
        preRenderCallbackWookie((WookieEntity) entity, f);
    }

    
    protected void preRenderCallbackWookie(WookieEntity entity, float f)
    {
