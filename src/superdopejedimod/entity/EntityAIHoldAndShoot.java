...
public class EntityAIHoldAndShoot extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        if (this.attackIntervalCounter == 0)
        {
            ...
            float distanceRatio = MathHelper.sqrt_double(distSquared) / this.attackRadius; // ratio 0.0-1.0 of how far it is towards maximum distance
            distanceRatio = MathHelper.clamp_float(distanceRatio, 0.1F, 1.0F); // clamp it between 0.1-1.0
