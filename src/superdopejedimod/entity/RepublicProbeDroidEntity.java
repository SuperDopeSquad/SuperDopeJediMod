...
public class RepublicProbeDroidEntity extends BaseEntityAnimal {
				
	
	public RepublicProbeDroidEntity(World worldIn) {
		
		super(worldIn, "republicProbeDroidEntity", "Republic Probe Droid");
	...
	public void registerRecipe() {
		ItemStack stack1 = new ItemStack(SuperDopeJediMod.mandalorianIron);	
		ItemStack stack2 = new ItemStack(Items.REDSTONE);
		GameRegistry.addRecipe(new ItemStack(SuperDopeJediMod.entityManager.republicProbeDroidEgg, 1), 
			" x ", "xyx", " x ", 
			'x', stack1, 'y', stack2);
	}
	...
	protected void setupAI()
	{
		...
		clearAITasks(); 
		   ...
		   // Main AI task list.
		   this.tasks.addTask(1, new EntityAIAttackMeleeFactionAware(this, 1.0, false, SuperDopeJediMod.classManager.getFactionInfo(SuperDopeJediMod.classManager.FACTION_EMPIRE)));
