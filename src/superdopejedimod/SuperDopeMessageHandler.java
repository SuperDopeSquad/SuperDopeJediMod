...
public class SuperDopeMessageHandler implements IMessageHandler<SuperDopePacketMessage, IMessage> {
// Do note that the default constructor is required, but implicitly defined in this case

	
	@Override 
	public IMessage onMessage(SuperDopePacketMessage message, MessageContext ctx) {
